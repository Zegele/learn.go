...
import (
	"fmt"
	"learn.go/zuoye/dianti/diantikuozhan/ren"
	"testing"
)
...
func TestToUpOrDown(t *testing.T) {
	...
	DianTi.Ren.WantFloorSlice = []int{5, 2, 1, 1, 4, 4, 4, 2, 1} //上面一行和这样两种写法效果相同？ 貌似是的//1245 3 4 5 2 1
	...
	fmt.Println("123165465", DianTi.MostWantFloors)
	fmt.Println("123165465", DianTi.MostWantF)
	fmt.Println("123165465", DianTi.ToUpFloorSlice)
	fmt.Println("123165465", DianTi.ToDownFloorSlice)
	fmt.Println(DianTi)
