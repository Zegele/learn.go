...
type PersonalInformation struct {
	...
	Password int64 `protobuf:"varint,3,opt,name=password,proto3" json:"password,omitempty"`
	...
	Onlinevisiable bool `protobuf:"varint,5,opt,name=onlinevisiable,proto3" json:"onlinevisiable,omitempty"`
}
...
func (x *PersonalInformation) GetPassword() int64 {
	if x != nil {
		return x.Password
	}
	return 0
...
func (x *PersonalInformation) GetOnlinevisiable() bool {
	if x != nil {
		return x.Onlinevisiable
	}
	return false
}
...
var file_types_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x22, 0x97, 0x01, 0x0a, 0x13, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x49,
	...
	,
...
var file_types_proto_goTypes = []interface{}{
	(*PersonalInformation)(nil), // 0: api.PersonalInformation
}
var file_types_proto_depIdxs = []int32{
	0, // 0: api.Client_Service.Register:input_type -> api.PersonalInformation
	0, // 1: api.Client_Service.Register:output_type -> api.PersonalInformation
...
func (c *client_ServiceClient) Register(ctx context.Context, in *PersonalInformation, opts ...grpc.CallOption) (*PersonalInformation, error) {
	out := new(PersonalInformation)
	err := c.cc.Invoke(ctx, "/api.Client_Service/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedClient_ServiceServer can be embedded to have forward compatible implementations.
type UnimplementedClient_ServiceServer struct {
}

func (*UnimplementedClient_ServiceServer) Register(context.Context, *PersonalInformation) (*PersonalInformation, error) {
...
func _Client_Service_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PersonalInformation)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(Client_ServiceServer).Register(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Client_Service/Register",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Client_ServiceServer).Register(ctx, req.(*PersonalInformation))
	}
	return interceptor(ctx, in, info, handler)
}

var _Client_Service_serviceDesc = grpc.ServiceDesc{
	ServiceName: "api.Client_Service",
	HandlerType: (*Client_ServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Register",
			Handler:    _Client_Service_Register_Handler,
		},
	},
