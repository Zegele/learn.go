...
type PersonalInformationFatRate struct {
	...
	Name    string  `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	FarRate float32 `protobuf:"fixed32,2,opt,name=farRate,proto3" json:"farRate,omitempty"` //这里小写，grpc里也会大写的。（大写应该是方便JSON的使用要求）
}
...
func (x *PersonalInformationFatRate) GetFarRate() float32 {
	if x != nil {
		return x.FarRate
	}
	return 0
...
var file_types_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x66, 0x61, 0x72, 0x52,
	0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x07, 0x66, 0x61, 0x72, 0x52, 0x61,
	...
	0x09, 0x5a, 0x07, 0x2e, 0x2e, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
